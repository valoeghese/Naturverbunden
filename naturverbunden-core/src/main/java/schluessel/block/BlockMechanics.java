 ...
 */
// TODO make schluessel.block.Block final -- yet an interface on the vanilla class? Can't do both... And make BlockMechanics an interface or class which is a parameter of Block via the builder
// TODO make a class schluessel.block.[Vanilla]Blocks which contains fields for every block, created as mass python code to create all the constants.
