...
public class FakeItemBlock extends Block {
	public FakeItemBlock(Settings settings) {
		super(settings);
	}
	...
	public static final VoxelShape SHAPE = Block.createCuboidShape(0, 0, 0, 16.0, 1.0, 16.0);
}
